...
<div class="card">
      <div class="card-header">
        <h3 class="card-title"><i class="fa fa-comments"></i> <?php echo $jkl['g353'];?></h3>
      </div><!-- /.box-header -->
      <div class="card-body">

        <label><?php echo $jkl["g354"];?></label>
        <div class="form-check form-check-radio">
            <label class="form-check-label">
              <input class="form-check-input" type="radio" name="jak_chatgptbot" value="1"<?php if (JAK_OPENAI_CHATGPT == 1) echo " checked";?>>
                <span class="form-check-sign"></span>
                <?php echo $jkl["g19"];?>
            </label>
        </div>
        <div class="form-check form-check-radio">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" name="jak_chatgptbot" value="0"<?php if (JAK_OPENAI_CHATGPT == 0) echo " checked";?>>
                <span class="form-check-sign"></span>
                <?php echo $jkl["g18"];?>
            </label>
        </div>
        ...
        <div class="form-group">
          <p><label><?php echo $jkl["g361"];?></label></p>
          <select name="jak_chatgpt_version" class="selectpicker" title="<?php echo $jkl["g361"];?>">
            <option value="gpt-4o-mini"<?php if (JAK_CHATGPT_VERSION == "gpt-4o-mini") echo " selected";?>>gpt-4o-mini</option>
            <option value="gpt-4o"<?php if (JAK_CHATGPT_VERSION == "gpt-4o") echo " selected";?>>gpt-4o</option>
          </select>
        </div>

        <div class="form-group">
          <label for="openaiapikey"><?php echo $jkl["g355"];?></label>
          <input type="text" name="jak_openaiapikey" id="openaiapikey" class="form-control" value="<?php echo JAK_OPENAI_APIKEY;?>">
        </div>
