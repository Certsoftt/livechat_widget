...
define('JAKDB_USER', 'Database user'); // Database user ## Datenbank Benutzername
define('JAKDB_PASS', 'Database password'); // Database password ## Datenbank Passwort
define('JAKDB_NAME', 'Database name'); // Database name ## Datenbank Name
define('JAKDB_PREFIX', 'lc3_'); // Database prefix use (a-z) and (_)

// Define a unique key for your site, don't change this, or people can't login anymore. (https://jakweb.ch/faq/a/99/database-and-password-hash)
define('DB_PASS_HASH', 'Ubsimple123%%%');

// Define your site url, for example: www.jakweb.ch (https://jakweb.ch/faq/a/98/full-site-domain)
define('FULL_SITE_DOMAIN', 'your site url');
...
$jakhs['copyright'] = '<a href="https://jakweb.ch" target="_blank">Powered by Live Chat 3</a>'; // the copyright link/text e.g. <a href="https://jakweb.ch" target="_blank">Powered by Live Chat 3</a>
